...
typedef void (*wm_wifi_oneshot_callback)(int state, unsigned char *ssid, unsigned char *key);
...
void tls_wifi_oneshot_callback_register(wm_wifi_oneshot_callback callback);

void tls_wifi_oneshot_callback_delete(void);
